  ...
  return (
    <aside className="sidebar">
      <Link to="/admin-dashboard" className="sb-logo" style={{ textDecoration: 'none' }}>
        <img src="/dienbien_logo.svg" alt="Dienbien.today" style={{ height: '36px', width: 'auto', objectFit: 'contain' }} />
        <div>
          <div className="sb-logo-name" style={{ fontWeight: 800, fontSize: '15px' }}>Dienbien.today</div>
